    ...
    render() {
        return (
            <ul>
                ...
                {this.renderCourse({'title': 'UX for Developers', 'description': 'This User Experience (UX) course examines how to develop a system for approaching application development and enhacing the experience for users.'})}
            </ul>
        )
    }
}
